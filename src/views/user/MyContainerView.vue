<template>
  <div class="container3">
    <el-breadcrumb class="bread" separator="/">
      ...
      <el-breadcrumb-item><a href="/">我的容器</a></el-breadcrumb-item>
    </el-breadcrumb>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px;">
            ...
            <div style="float:right;">
              <el-button size="small" @click="openTerminal(i.ContainerID)">控制台</el-button>
              ...
              <el-dropdown style="margin-left:10px;" size="small">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item>创建镜像</el-dropdown-item>
    ...
    <el-dialog :title="`容器创建`" :visible.sync="dialogVisible2" width="40%">
      <el-form>
        ...
        <el-form-item label="容器镜像" required>
          <el-select v-model="containerForm.ImageName" placeholder="请选择镜像">
        ...
        <el-form-item>
          <el-button style="float:right;" type="primary" @click="handleCreateContainer">创建</el-button>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      handleCreateContainer() {
        this.$store.dispatch('container/create', this.containerForm).then(({
          data
        }) => {
          console.log(data)
          this.$message({
      ...
      listContainer() {
        this.$store.dispatch('container/list', this.payload).then(({
          data
        }) => {
          console.log(data)
          this.list = data.Data
